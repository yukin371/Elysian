...
export const enUSSettingLocaleMessages: VueLocaleMessages = {
  ...
  "app.setting.form.keyPlaceholder": "Enter config key",
  "app.setting.form.valuePlaceholder": "Enter config value",
  "app.setting.form.descriptionPlaceholder": "Describe the config entry",
