...
export const enUSUserLocaleMessages: VueLocaleMessages = {
  ...
  "app.user.form.usernamePlaceholder": "Enter username",
  "app.user.form.displayNamePlaceholder": "Enter display name",
  "app.user.form.emailPlaceholder": "Enter email",
  "app.user.form.phonePlaceholder": "Enter phone number",
