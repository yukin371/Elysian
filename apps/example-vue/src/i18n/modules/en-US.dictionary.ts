...
export const enUSDictionaryLocaleMessages: VueLocaleMessages = {
  ...
  "app.dictionary.form.codePlaceholder": "Enter dictionary code",
  "app.dictionary.form.namePlaceholder": "Enter dictionary name",
  "app.dictionary.form.descriptionPlaceholder": "Describe the dictionary",
