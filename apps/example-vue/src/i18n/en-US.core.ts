...
export const enUSCoreLocaleMessages: VueLocaleMessages = {
  ...
  "app.action.exportDictionaryTypes": "Export dictionary types",
  "app.action.exportDictionaryItems": "Export dictionary items",
  ...
  "app.action.newSetting": "New config entry",
  "app.action.exportSettings": "Export config entries",
  ...
  "app.action.exportNotifications": "Export notifications",
  "app.action.markVisibleNotificationsRead": "Mark visible as read ({count})",
  ...
  "app.fallback.settings": "Config Entries",
