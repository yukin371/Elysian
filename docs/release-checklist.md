...
| 基础验证命令结果 | `ELYSIAN_GO_LIVE_CHECK_PASSED` / `ELYSIAN_GO_LIVE_BUILD_VUE_PASSED` / `ELYSIAN_GO_LIVE_SMOKE_FULL_PASSED` / `ELYSIAN_GO_LIVE_SERVER_IMAGE_VERIFY_PASSED` / `ELYSIAN_GO_LIVE_TENANT_FULL_PASSED` |
