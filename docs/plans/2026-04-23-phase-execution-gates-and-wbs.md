...
> 历史说明：本文形成于 `Phase 6A Round-2` 收尾期间，主要作用是固化“阶段入口/出口/WBS”执行模板，并用当时的 `Phase 6A Round-2` 做示例。模板本身仍可复用，但“当前执行对象”部分已不代表现阶段主线；当前进度以 [06-phased-implementation-plan.md](../06-phased-implementation-plan.md) 与 [roadmap.md](../roadmap.md) 为准。
...
- 继续把本文视为通用阶段模板，而不是活跃任务单。
- 若要看当前活跃工作包，应转到 `Phase 6B / P6B3` 的设计文档、runbook 与主计划。
