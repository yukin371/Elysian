...
- `validate -> e2e-generator-(matrix|cli|studio|browser|safe-apply) -> reports:index -> reports:gate`
...
| `e2e-generator-*.json` | generator matrix / cli / studio / browser 报告 | `e2e:generator:*` |
